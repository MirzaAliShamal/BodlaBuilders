...
@section('title', 'Bodla Developer Team')
@section('nav-title', 'Bodla Developer Team')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.developer.team.save', $team->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card ">
