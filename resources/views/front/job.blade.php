                    ...
                    <div class="col-lg-4 col-md-6 mt-4">
                        <div class="card blog rounded border-0 shadow">
                            <div class="shop-image position-relative">
                                <img src="{{ asset('news/job.jpg') }}" class="card-img-top rounded-top" alt="...">
                            <div class="overlay rounded-top bg-dark"></div>
                            </div>
                            <div class="card-body content">
                                <h5><a href="{{ route('jobs',$item->slug) }}" class="card-title title text-dark">{{ Str::limit($item->title, 60, '...') }}</a></h5>
                                <div class="post-meta d-flex justify-content-between mt-3">
                                    <a href="{{ route('jobs',$item->slug) }}" class="text-muted readmore">Read More <i class="uil uil-angle-right-b align-middle"></i></a>
                                </div>
                            </div>
                            <div class="author">
                                <small class="text-light date"><i class="uil uil-calendar-alt"></i> {{ $item->created_at->format('d M, Y') }}</small>
                            </div>
                            <div class="container" style="margin-left: 60%; margin-bottom: 20px">
