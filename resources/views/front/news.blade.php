            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <h2 class="mb-4"><strong>News</strong></h2>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4">
                        <div class="card blog rounded border-0 shadow">
                            ...
                            <div class="card-body content">
                                <h5><a href="{{ route('news', $item->slug) }}" class="card-title title text-dark">{{ Str::limit($item->title, 60, '...') }}</a></h5>
                                <div class="post-meta d-flex justify-content-between mt-3">
                                    <a href="{{ route('news', $item->slug) }}" class="text-muted readmore">Read More <i class="uil uil-angle-right-b align-middle"></i></a>
                                </div>
                            </div>
                            <div class="author">
